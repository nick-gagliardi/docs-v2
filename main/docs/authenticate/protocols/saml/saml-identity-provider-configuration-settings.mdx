...
* [CER](https://{yourDomain}/pem?cert=connection&format=cer)
* [PEM](https://{yourDomain}/pem?cert=connection&format=pem)
* [raw PEM](https://{yourDomain}/pem?cert=connection&format=rawpem)
* [PKCS#7](https://{yourDomain}/pem?cert=connection&format=pkcs7)
* [Fingerprint](https://{yourDomain}/pem?cert=connection&format=fingerprint)
...
Use the ACS URL (post-back URL) for your organization in the federated IdP to start the Organizations login flow. The ACS URL is `https://{yourDomain}/login/callback`. To start the flow, use the following login URL with your connection and organization parameters:
